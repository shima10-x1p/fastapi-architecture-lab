...
class CreateFavoriteRequest(BaseModel):
    ...
    """ # noqa: E501
    video_id: Annotated[str, Field(strict=True)] = Field(description="YouTube の動画 ID", alias="videoId")
    ...
    __properties: ClassVar[List[str]] = ["videoId", "title", "channelName", "thumbnailUrl", "memo", "tags"]

    @field_validator('video_id')
    def video_id_validate_regular_expression(cls, value):
